...
// MaxNameLen caps c2-session display name length, measured in runes (not
...
// Rename validates and atomically updates the display name of a c2-session.
...
func Rename(store core.ArchiveStore, id, newName string) (core.C2Entry, error) {
